    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">Apple Experience 3D</h1>
          <p className="project-subtitle">
            A cutting-edge 3D Apple iPhone showcase built with modern web tech — explore devices like never before. A futuristic product experience for next-gen consumers.
          </p>
        </div>
        <div className="content-section">
          <div className="section-row">
            ...
            <p className="section-content">
              Explore Apple devices in a whole new dimension. This interactive 3D showcase leverages the latest web technologies to deliver a futuristic, immersive product experience for next-gen consumers and Apple fans.
            </p>
          </div>
          <div className="section-row">
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={AppleExperienceV1} 
              alt="Apple Experience 3D main interface"
              className="main-image"
              onClick={() => openPreview(AppleExperienceV1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={AppleExperienceV2} 
                alt="Apple Experience 3D alternate view"
                className="secondary-image"
                onClick={() => openPreview(AppleExperienceV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={AppleExperienceV1} 
                alt="Apple Experience 3D third view"
                className="secondary-image"
                onClick={() => openPreview(AppleExperienceV1)}
                style={{ cursor: 'pointer' }}
              />
