    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">Outdoor Landscape Design</h1>
          <p className="project-subtitle">
            A comprehensive outdoor landscape design platform that transforms outdoor spaces into stunning, functional environments. From concept to completion, every detail matters.
          </p>
        </div>
        ...
        <div className="content-section">
          <div className="section-row">
            ...
            <p className="section-content">
              Outdoor Landscape Design is a professional platform that helps users visualize and plan their outdoor spaces. Whether it's a backyard garden, commercial landscape, or public park, this tool provides comprehensive design solutions with 3D visualization, plant selection, and project management features.
            </p>
          </div>
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={OutdoorLandcsapeV1} 
              alt="Outdoor Landscape main interface"
              className="main-image"
              onClick={() => openPreview(OutdoorLandcsapeV1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={OutdoorLandscapeV2} 
                alt="Outdoor Landscape alternate view"
                className="secondary-image"
                onClick={() => openPreview(OutdoorLandscapeV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={OutDoorLandscapeV3} 
                alt="Outdoor Landscape third view"
                className="secondary-image"
                onClick={() => openPreview(OutDoorLandscapeV3)}
                style={{ cursor: 'pointer' }}
              />
            </div>
          </div>
...
export default OutdoorLandscape; 