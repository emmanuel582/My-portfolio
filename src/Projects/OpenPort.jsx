    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">OpenPort</h1>
          <p className="project-subtitle">
          Game-changing JavaScript library that eliminates API complexity through intelligent LLM integration and machine learning automation. Features zero-config image generation, sentiment analysis pipelines, and web scraping modules. Built with TypeScript and modular architecture, this library empowers developers to build powerful applications without API key management headaches.
          </p>
        </div>
        <div className="content-section">
          ...
          <div className="section-row">
            ...
            <div className="tech-tags">
              ...
              <span className="tech-tag">LLM (Gemini/OpenAI)</span>
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={OpenPortV1} 
              alt="OpenPort main interface"
              className="main-image"
              onClick={() => openPreview(OpenPortV1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={OpenPortV2} 
                alt="OpenPort alternate view"
                className="secondary-image"
                onClick={() => openPreview(OpenPortV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={OpenPortV3} 
                alt="OpenPort third view"
                className="secondary-image"
                onClick={() => openPreview(OpenPortV3)}
                style={{ cursor: 'pointer' }}
              />
            </div>
          </div>
