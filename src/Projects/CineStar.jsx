    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">CineStar – Movie Explorer</h1>
          <p className="project-subtitle">
            A slick, dynamic movie discovery platform packed with trending trailers, cast previews & dark UI perfection. Built to entertain. Optimized to impress.
          </p>
        </div>
        <div className="content-section">
          <div className="section-row">
            ...
            <p className="section-content">
              Discover trending movies, watch trailers, and explore cast previews in a beautifully designed, dark-themed SaaS platform. CineStar is built for movie lovers and entertainment seekers.
            </p>
          </div>
          <div className="section-row">
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={CinetsarV1} 
              alt="CineStar main interface"
              className="main-image"
              onClick={() => openPreview(CinetsarV1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={CinestarV2} 
                alt="CineStar alternate view"
                className="secondary-image"
                onClick={() => openPreview(CinestarV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={CineStarv3} 
                alt="CineStar third view"
                className="secondary-image"
                onClick={() => openPreview(CineStarv3)}
                style={{ cursor: 'pointer' }}
              />
            </div>
          </div>
