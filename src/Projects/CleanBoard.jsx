    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">Clean Board SaaS</h1>
          <p className="project-subtitle">
            A full-fledged SaaS dashboard for modern teams. Think Trello meets sleek design — real-time task control, smooth UX, and intuitive team workflow boards.
          </p>
        </div>
        <div className="content-section">
          <div className="section-row">
            ...
            <p className="section-content">
              Clean Board is a modern SaaS dashboard for teams, offering real-time task management, beautiful UX, and intuitive workflow boards. Perfect for productivity-driven organizations.
            </p>
          </div>
          <div className="section-row">
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={CleanBoardv1} 
              alt="Clean Board main interface"
              className="main-image"
              onClick={() => openPreview(CleanBoardv1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={CleanBoardV2} 
                alt="Clean Board alternate view"
                className="secondary-image"
                onClick={() => openPreview(CleanBoardV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={CleanBoardv3} 
                alt="Clean Board third view"
                className="secondary-image"
                onClick={() => openPreview(CleanBoardv3)}
                style={{ cursor: 'pointer' }}
              />
            </div>
          </div>
