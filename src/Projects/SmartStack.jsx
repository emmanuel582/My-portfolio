    ...
    <>
      ...
      <div className="overall-container">
        ...
        <div className="project-header">
          <h1 className="project-title">SmartStack</h1>
          <p className="project-subtitle">
            Revolutionary SaaS platform that generates optimal project architectures using machine learning and code analysis algorithms.
          </p>
        </div>
        <div className="content-section">
          <div className="section-row">
            ...
            <p className="section-content">
              Features intelligent file structure generation, automated dependency optimization, and best-practice JSON schema creation. Eliminates development setup time by 80% through AI-powered project scaffolding and architecture recommendations.
            </p>
          </div>
          <div className="section-row">
            ...
            <div className="tech-tags">
              ...
              <span className="tech-tag">AST Parser</span>
              <span className="tech-tag">AI Code Generator</span>
        ...
        <div className="project-images">
          <div className="main-image-container">
            <img 
              src={SmartStackV1} 
              alt="SmartStack main interface"
              className="main-image"
              onClick={() => openPreview(SmartStackV1)}
          ...
          <div className="secondary-images">
            <div className="secondary-image-container">
              <img 
                src={SmartStackV2} 
                alt="SmartStack alternate view"
                className="secondary-image"
                onClick={() => openPreview(SmartStackV2)}
                style={{ cursor: 'pointer' }}
              />
            </div>
            <div className="secondary-image-container">
              <img 
                src={SmartStackV3} 
                alt="SmartStack third view"
                className="secondary-image"
                onClick={() => openPreview(SmartStackV3)}
                style={{ cursor: 'pointer' }}
              />
            </div>
          </div>
